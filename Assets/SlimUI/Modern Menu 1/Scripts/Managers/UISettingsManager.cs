...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
        ...
        private void InitializeAudioSliders()
        {
            ...
            {
                masterVolumeSlider.GetComponent<Slider>().value = AudioManager.Instance.GetMasterVolume();
            }

            if (musicVolumeSlider != null && AudioManager.Instance != null)
            {
                musicVolumeSlider.GetComponent<Slider>().value = AudioManager.Instance.GetMusicVolume();
            }

            if (sfxVolumeSlider != null && AudioManager.Instance != null)
            {
                sfxVolumeSlider.GetComponent<Slider>().value = AudioManager.Instance.GetSFXVolume();
            }
        }
        ...
        public void SetMasterVolume()
        {
            if (masterVolumeSlider != null && AudioManager.Instance != null)
            {
                float volume = masterVolumeSlider.GetComponent<Slider>().value;
        ...
        public void SetMusicVolume()
        {
            if (musicVolumeSlider != null && AudioManager.Instance != null)
            {
                float volume = musicVolumeSlider.GetComponent<Slider>().value;
                AudioManager.Instance.SetMusicVolume(volume);
            }
        }
        ...
        public void SetSFXVolume()
        {
            if (sfxVolumeSlider != null && AudioManager.Instance != null)
            {
                float volume = sfxVolumeSlider.GetComponent<Slider>().value;
